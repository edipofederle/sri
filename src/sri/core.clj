...
(defn -main
  ...
  (if (seq args)
    ...
    (do
      ...
      (println "")
      (println "Usage:")
      (println "  sri <filename>            Run a Ruby file")
      (println "  sri -e <code>             Evaluate a Ruby expression")
      (println "  sri <filename> [args...]  Run a Ruby file with ARGV")
      (println "")
      (println "Examples:")
      (println "  sri script.rb")
      (println "  sri -e \"puts 'Hello, World!'\"")
      (println "  sri -e \"[1,2,3].map { |x| x * 2 }\"")
      (println "")
      (println "Library usage (Clojure):")
      (println "  (require '[sri.core :as sri])")
      (println "  (sri/eval-string \"1 + 2\")  ; => 3")
      (System/exit 1))))
