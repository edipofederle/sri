...
(def keywords
  #{"if" "else" "elsif" "end" "while" "def" "class" "module" "nil" "true" "false" "and" "or" "not" "return" "break" "continue" "next" "self" "case" "when" "for" "until" "in" "loop" "do" "yield" "attr_accessor" "attr_reader" "attr_writer"})
